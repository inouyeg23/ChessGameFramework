...
public class King extends Piece {
    ...
    public boolean canMove(int row, int col, int selectRow, int selectCol) {
        ...
        //returns true if they equal eachother or one equals 0, and limits the distance to 1 in any direction
        if (((rowFinal == 0 || colFinal ==0 || (rowFinal == colFinal)) && rowFinal <= 1 && colFinal <= 1) && noAlly && empty) {
            return true;
        }
        return false;
    }
